...
public class SlotsValidator {
    ...
    public static boolean isPerfectStraight(List<String> symbols) { // F.eks 345 or 543
    ...
    public static boolean isStraight(List<String> symbols) { // F.eks 354, 798, 132
        ...
        return (( splitStringForInt(copyOfSymbols.get(0)) - splitStringForInt(copyOfSymbols.get(1))) == 1 // 5-4 = 1
                && splitStringForInt(copyOfSymbols.get(1)) - splitStringForInt(copyOfSymbols.get(2)) == 1); // 4-3 = 1, then straight
    }

    public static boolean isDevil(List<String> symbols) { // 666
        return splitStringForInt(symbols.get(0)) == 6
                && splitStringForInt(symbols.get(1)) == 6
